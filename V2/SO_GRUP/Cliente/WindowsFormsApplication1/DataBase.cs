...
namespace WindowsFormsApplication1
{
    public partial class DataBase : Form
    {
        ...
        public DataBase()
        {
            ...
            partidasGrid.Columns[2].HeaderText = "HOST";
            partidasGrid.Columns[3].HeaderText = "DATE";
            partidasGrid.Columns[4].HeaderText = "WINNER";
        ...
        public void InitializePartidas(string partidas)
        {
            ...
            while (j < i)   //insertem a la taula partidasGrid els parametres de cada partida
            {
                ...
                partidasGrid.Rows[j].Cells[2].Value = id_serv[j];
                partidasGrid.Rows[j].Cells[3].Value = date[j];
                partidasGrid.Rows[j].Cells[4].Value = guanyador[j];
                j++;
            }
        }
    }
