...
namespace WindowsFormsApplication1
{
    public partial class GameWndw : Form
    {
        ...
        //SYMBOLS
        List<int> vectorimatges_host =  new List<int> { -1 };
        List<int> vectorimatges_jugador = new List<int> { -1 };
        ...
        public void StartGameSymbols(string vectorimatges, int destinat)
        {
            ...
            Imagen4.Show();
            Imagen5.Show();
            this.Imagen1.Enabled = true;
            this.Imagen2.Enabled = true;
            this.Imagen3.Enabled = true;
            this.Imagen4.Enabled = true;
            this.Imagen5.Enabled = true;
            int k = 0;
            ...
            {
                this.Imagen1.Enabled =false;
                this.Imagen2.Enabled = false;
                this.Imagen3.Enabled = false;
                this.Imagen4.Enabled = false;
                this.Imagen5.Enabled = false;
                ...
                Imagen1.Image = vecimag[vectorimatges[0]];
                if (vectorimatges[1] != -1)
                {
                    Imagen2.Image = vecimag[vectorimatges_host[1]];
                }
                else
                {
                    Imagen2.Hide();
                }
                if (vectorimatges[2] != -1)
                {
                    Imagen3.Image = vecimag[vectorimatges_host[2]];
                }
                else
                {
                    Imagen3.Hide();
                }
                if (vectorimatges[3] != -1)
                {
                    Imagen4.Image = vecimag[vectorimatges_host[3]];
                }
                else
                {
                    Imagen4.Hide();
                }
                if (vectorimatges[4] != -1)
                {
                    Imagen5.Image = vecimag[vectorimatges_host[4]];
                }
                else
                {
                    Imagen5.Hide();
            ...
            else if (destinat == 1)
            {
                ...
                Imagen1.Image = vecimag[vectorimatges_jugador[0]];
                Imagen2.Image = vecimag[vectorimatges_jugador[1]];
                Imagen3.Image = vecimag[vectorimatges_jugador[2]];
                Imagen4.Image = vecimag[vectorimatges_jugador[3]];
                Imagen5.Image = vecimag[vectorimatges_jugador[4]];
            }
        ...
        private void Imagen1_Click(object sender, EventArgs e)
        {
            ...
            if (PLAYERS[2] == this.USER)
            {
                for (int k = 0; k < 5; k++)
                {
                    if (vectorimatges_jugador[5] == vectorimatges_host[k])
                    {
                        MessageBox.Show("Correcto");
                    }
                    else
            ...
            if (PLAYERS[3] == this.USER)
            {
                for (int k = 0; k < 5; k++)
                {
                    if (vectorimatges_jugador[10] == vectorimatges_host[k])
                    {
                        MessageBox.Show("Correcto");
                    }
                    else
            ...
            if (PLAYERS[4] == this.USER)
            {
                for (int k = 0; k < 5; k++)
                {
                    if (vectorimatges_jugador[15] == vectorimatges_host[k])
                    {
                        MessageBox.Show("Correcto");
                    }
                    else
        ...
        private void Imagen2_Click(object sender, EventArgs e)
        {
            ...
            if (PLAYERS[2] == this.USER)
            {
                for (int k = 0; k < 5; k++)
                {
                    if (vectorimatges_jugador[6] == vectorimatges_host[k])
                    {
                        MessageBox.Show("Correcto");
                    }
                    else
            ...
            if (PLAYERS[3] == this.USER)
            {
                for (int k = 0; k < 5; k++)
                {
                    if (vectorimatges_jugador[11] == vectorimatges_host[k])
                    {
                        MessageBox.Show("Correcto");
                    }
                    else
            ...
            if (PLAYERS[4] == this.USER)
            {
                for (int k = 0; k < 5; k++)
                {
                    if (vectorimatges_jugador[16] == vectorimatges_host[k])
                    {
                        MessageBox.Show("Correcto");
                    }
                    else
        ...
        private void Imagen3_Click(object sender, EventArgs e)
        {
            ...
            if (PLAYERS[2] == this.USER)
            {
                for (int k = 0; k < 5; k++)
                {
                    if (vectorimatges_jugador[7] == vectorimatges_host[k])
                    {
                        MessageBox.Show("Correcto");
                    }
                    else
            ...
            if (PLAYERS[3] == this.USER)
            {
                for (int k = 0; k < 5; k++)
                {
                    if (vectorimatges_jugador[12] == vectorimatges_host[k])
                    {
                        MessageBox.Show("Correcto");
                    }
                    else
            ...
            if (PLAYERS[4] == this.USER)
            {
                for (int k = 0; k < 5; k++)
                {
                    if (vectorimatges_jugador[17] == vectorimatges_host[k])
                    {
                        MessageBox.Show("Correcto");
                    }
                    else
        ...
        private void Imagen4_Click(object sender, EventArgs e)
        {
            ...
            if (PLAYERS[2] == this.USER)
            {
                for (int k = 0; k < 5; k++)
                {
                    if (vectorimatges_jugador[8] == vectorimatges_host[k])
                    {
                        MessageBox.Show("Correcto");
                    }
                    else
            ...
            if (PLAYERS[3] == this.USER)
            {
                for (int k = 0; k < 5; k++)
                {
                    if (vectorimatges_jugador[13] == vectorimatges_host[k])
                    {
                        MessageBox.Show("Correcto");
                    }
                    else
            ...
            if (PLAYERS[4] == this.USER)
            {
                for (int k = 0; k < 5; k++)
                {
                    if (vectorimatges_jugador[18] == vectorimatges_host[k])
                    {
                        MessageBox.Show("Correcto");
                    }
                    else
        ...
        private void Imagen5_Click(object sender, EventArgs e)
        {
            ...
            if (PLAYERS[2] == this.USER)
            {
                for (int k = 0; k < 5; k++)
                {
                    if (vectorimatges_jugador[9] == vectorimatges_host[k])
                    {
                        MessageBox.Show("Correcto");
                    }
                    else
            ...
            if (PLAYERS[3] == this.USER)
            {
                for (int k = 0; k < 5; k++)
                {
                    if (vectorimatges_jugador[14] == vectorimatges_host[k])
                    {
                        MessageBox.Show("Correcto");
                    }
                    else
            ...
            if (PLAYERS[4] == this.USER)
            {
                for (int k = 0; k < 5; k++)
                {
                    if (vectorimatges_jugador[19] == vectorimatges_host[k])
                    {
                        MessageBox.Show("Correcto");
                    }
                    else
